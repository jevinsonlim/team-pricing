...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink v-if="$page.props.auth.can.view_any_team" :href="route('team.index')"
                                    :active="route().current('team.index')">
                                    Teams
                                </NavLink>

                                <NavLink v-if="$page.props.auth.can.view_any_part" :href="route('part.index')"
                                    :active="route().current('part.index')">
                                    Parts
                                </NavLink>

                                <NavLink v-if="$page.props.auth.can.view_any_part_upload"
                                    :href="route('part_upload.index')" :active="route().current('part_upload.index')">
                                    Part Uploads
                                </NavLink>

                                <NavLink v-if="$page.props.auth.can.create_part_upload"
            ...
            <!-- Page Content -->
            <main>
                <div v-if="$page.props.flash.message" class="mx-auto pt-1 max-w-7xl sm:px-6 lg:px-8">
                    <Message closable>{{ $page.props.flash.message }}</Message>
                </div>
