                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <DataTable v-model:filters="filters" :value="teamParts" paginator showGridlines :rows="10"
                            ...
                            <Column header="Part type" style="min-width: 12rem"
                                export-header="Part Type" filterField="part.part_type">
                                <template #body="{ data }">
                                    {{ data.part.part_type }}
                                </template>
                            ...
                            <Column header="Model number" style="min-width: 12rem"
                                export-header="Model Number" filterField="part.model_number">
                                <template #body="{ data }">
                            ...
                            <Column header="Multiplier" dataType="numeric" style="min-width: 10rem"
                                export-header="List Price" field="multiplier">
                                <template #body="{ data }">
                                    {{ data.multiplier }}
                                </template>
                                <template #filter="{ filterModel }">
